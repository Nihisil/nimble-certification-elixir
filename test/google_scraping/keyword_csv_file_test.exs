defmodule GoogleScraping.Dashboard.Schemas.KeywordCSVFileTest do
  ...
  describe "create_changeset/1" do
    test "when file exists, returns valid changeset" do
      attrs = %{file: file_fixture("files/valid.csv")}
    ...
    test "when file is not CSV, returns invalid changeset" do
      attrs = %{file: file_fixture("files/invalid.txt")}
